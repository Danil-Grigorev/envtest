...
///     error_if_path_missing: true,
///     ..Default::default()
/// };
///
/// assert!(options.error_if_path_missing);
/// ```
#[derive(Default, Debug, Clone, PartialEq, Eq, Hash)]
#[cfg_attr(not(feature = "_docsrs"), derive(rust2go::R2G))]
pub struct CRDInstallOptions {
    ...
    /// Whether to error if any of the CRD source [`CRDInstallOptions::paths`] does not exist.
    pub error_if_path_missing: bool,
